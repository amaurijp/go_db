...
- `extraction_validation_data.json`: contains the extraction validation set used to calculate precision, recall and F1-score of the LLM extraction task performed in the article submitted to ACS Nano (nn-2026-04548e).
